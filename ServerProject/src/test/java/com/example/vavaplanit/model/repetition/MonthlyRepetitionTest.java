...
public class MonthlyRepetitionTest {
    ...
    class FigureOutDatesFromDayOfMonthTests {
        ...
        public void monthlyRepetitionEveryMonthOn20th() {
            ...
            LocalDate actualDate = createWeeklyRepetitionAndGetDates(1L, LocalDate.of(2020, 6, 20),
        ...
        public void monthlyRepetitionEveryMonthOn31st() {
            ...
            LocalDate actualDate = createWeeklyRepetitionAndGetDates(1L, LocalDate.of(2020, 1, 31),
        ...
        public void monthlyRepetitionEverySecondMonthWithoutOccurrenceInMonth() {
            ...
            List<LocalDate> actualDate = createWeeklyRepetitionAndGetDates(1L, LocalDate.of(2020, 1, 31),
        ...
        public void monthlyRepetitionEvery13thMonthWithOccurrenceInMonth() {
            ...
            LocalDate actualDate = createWeeklyRepetitionAndGetDates(1L, LocalDate.of(2019, 7, 15),
    ...
    class FigureOutDatesFromOrdinalAndDayOfWeekTests {
        ...
        public void monthlyRepetitionEveryMonthOnLastMonday() {
            ...
            LocalDate actualDate = createWeeklyRepetitionAndGetDates(1L, LocalDate.of(2020, 7, 27),
        ...
        public void monthlyRepetitionEveryMonthOnFirstFriday() {
            ...
            LocalDate actualDate = createWeeklyRepetitionAndGetDates(1L, LocalDate.of(2020, 7, 3),
        ...
        public void monthlyRepetitionEveryMonthOn2ndWednesday() {
            ...
            LocalDate actualDate = createWeeklyRepetitionAndGetDates(1L, LocalDate.of(2020, 7, 8),
        ...
        public void monthlyRepetitionEvery2ndMonthOn3rdThursday() {
            ...
            LocalDate actualDate = createWeeklyRepetitionAndGetDates(1L, LocalDate.of(2020, 6, 18),
        ...
        public void monthlyRepetitionEvery2ndMonthWithoutOccurrenceInMonth() {
            ...
            List<LocalDate> actualDate = createWeeklyRepetitionAndGetDates(1L, LocalDate.of(2020, 7, 16),
